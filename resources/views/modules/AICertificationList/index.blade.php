...
@section('title','Quản lý giấy chứng nhận')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sparkline8-list">
                            <h4>Danh sách giấy chứng nhận</h4>
                                            ...
                                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="false" data-show-toggle="true" data-resizable="false" data-cookie="false" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="false">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-field="id_course">Khóa đào tạo</th>
                                                        <th data-field="from_the_time">Ngày bắt đầu</th>
                                                        <th data-field="till_the_time">Ngày kết thúc</th>
...
@section('modal')
    @include('modules.AICertificationList.modal')
@endsection

@section('javascript')
    @include('modules.AICertificationList.javascripts')
@endsection
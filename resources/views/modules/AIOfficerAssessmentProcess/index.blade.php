...
@section('title','Quản lý quá trình đánh giá xếp loại giáo viên')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sparkline8-list">
                        <h4>Quá trình đánh giá xếp loại giáo viên</h4>
...
@section('modal')
    @include('modules.AIOfficerAssessmentProcess.modal')
@endsection
@section('javascript')
    @include('modules.AIOfficerAssessmentProcess.javascripts')
@endsection
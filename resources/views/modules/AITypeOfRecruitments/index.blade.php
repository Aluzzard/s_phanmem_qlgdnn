...
@section('title','Quản lý danh mục đối tượng tuyển sinh / ưu tiên')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sparkline8-list">
                            <h4>Danh sách danh mục đối tượng tuyển sinh / ưu tiên</h4>
...
@endsection
@section('javascript')
    @include('modules.AITypeOfRecruitments.javascripts')
@endsection
                            ...
                            <div class="sparkline8-graph">
                            	<form id="form-action" class="text-left">
                            		...
                            		<div class="row">
		                                ...
		                                <div class="col-md-4">
		                                    <div class="chosen-select-single mg-b-20">
		                                        <select class="chosen-select2 form-control" name="month" data-width="100%">
			                                        @for ($i = 1; $i <= 12; $i++)
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="datatable-dashv1-list custom-datatable-overright">
                                        	@if(request()->input())
                                            @include('modules.AIIntegratedStatistics.form_2.table')
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
@include('modules.AIIntegratedStatistics.form_2.javascripts')
